...
def main():
    ...
    if args.white_box_attack:
        ...
        model_target.load_state_dict(torch.load(args.target_model_path, map_location=torch.device(device)))
        model_source = SmallCNN().to(device)
        model_source.load_state_dict(torch.load(args.source_model_path, map_location=torch.device(device)))
