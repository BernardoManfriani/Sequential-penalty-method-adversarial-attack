...
parser = argparse.ArgumentParser(description='SmallCNN Classifier')
...
parser.add_argument('--model-dir', default='Adversarial-attacks-via-Sequential-Quadratic-Programming\checkpoints\smallcnn_regular',
